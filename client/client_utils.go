...
func (c ZeroRobot) doReqWithBody(method, urlStr string, data interface{}, headers, queryParams map[string]interface{}) (*http.Response, error) {
...
func (c ZeroRobot) doReqNoBody(method, urlStr string, headers, queryParams map[string]interface{}) (*http.Response, error) {
	return c.doReq(method, urlStr, nil, headers, queryParams)
}

func (c ZeroRobot) doReq(method, urlStr string, body io.Reader, headers, queryParams map[string]interface{}) (*http.Response, error) {
	// create the request
